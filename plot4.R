...
#two columns two rows, fills by row
par(mfrow=c(2,2))
plot(x=datasubset$DateTime,y=datasubset$Global_active_power,type="l",ylab="Global Active Power (kilowatts)",xlab="")
plot(x=datasubset$DateTime,y=datasubset$Voltage,type="l",ylab="Voltage",xlab="datetime")
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),bty="n",col=c("black","red","blue"),lwd=2)
plot(datasubset$DateTime, datasubset$Global_reactive_power, type = "l", main = "", xlab = "datetime")
